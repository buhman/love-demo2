...
transform const transforms_node_direct001[] = {
  {
    ...
    .matrix = {0.692005f, -0.7218927f, 0.0f, 0.0f, 0.6737756f, 0.64588f, 0.3589784f, 0.0f, -0.2591439f, -0.2484148f, 0.9333459f, 0.0f, -4.146301f, -3.974632f, 10.48219f, 1.0f},
  },
};
...
transform const transforms_node_camera001[] = {
  {
    .type = transform_type::MATRIX,
    .matrix = {-0.9161802f, -0.4006261f, -0.01059775f, 0.0f, 0.3124457f, -0.7305838f, 0.6071451f, 0.0f, -0.2509807f, 0.5529431f, 0.7945203f, 0.0f, -3.604237f, 4.948456f, 0.0f, 1.0f},
  },
};
